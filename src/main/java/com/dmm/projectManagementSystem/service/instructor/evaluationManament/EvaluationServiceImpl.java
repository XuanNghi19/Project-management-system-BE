...
public class EvaluationServiceImpl implements EvaluationService {
    ...
    public ApiResponse<String> createEvaluation(CreateEvaluationDTO createEvaluationDTO) {
        ...
        switch (createEvaluationDTO.getGradeType()) {
            case PROGRESS_SCORE:
                grade.get().setProgressScore(Double.valueOf(createEvaluationDTO.getGrade()));
                break;
            case REPORT_SCORE:
                grade.get().setReportScore(Double.valueOf(createEvaluationDTO.getGrade()));
                break;
            case DEFENSE_SCORE:
                grade.get().setDefenseScore(Double.valueOf(createEvaluationDTO.getGrade()));
                break;
            case REVIEW_SCORE:
                grade.get().setReviewScore(Double.valueOf(createEvaluationDTO.getGrade()));
                break;
            default:
                throw new IllegalArgumentException("Invalid score type: " + Double.valueOf(createEvaluationDTO.getGrade()));
        }
