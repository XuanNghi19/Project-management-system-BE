...
import com.dmm.projectManagementSystem.service.instructor.teamManagement.TeamByInstructorService;
...
@RestController
public class TeamByInstructorController {
    @Autowired
    private TeamByInstructorService teamService;
